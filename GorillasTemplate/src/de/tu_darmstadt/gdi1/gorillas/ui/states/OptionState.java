...
public class OptionState extends OwnState {
  ...
  public void init(GameContainer arg0, StateBasedGame arg1)
     ...
     // Erstellung der Entität für den Hintergrund
      ...
      zurueckE.addComponent(
          new ImageRenderComponent(new org.newdawn.slick.Image("assets/gorillas/background/entry.png")));

      
      
   // Events und Actions
      Event zurueckEvent = new ANDEvent(new MouseEnteredEvent(),new MouseClickedEvent());
    ...
    // Neues Spiel Action
      ...
      gorilla_logoE.addComponent(
          new ImageRenderComponent(new org.newdawn.slick.Image("assets/gorillas/background/Banner.png")));
